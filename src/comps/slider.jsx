      ...
      >
        ...
        {ServiceData.map((item) => (
          ...
          <SwiperSlide key={item.name} className="flex items-center py-6  justify-center">
            <div className="flex flex-col gap-6 group relative shadow-lg bg-white shadow-[#665c5c] borde border-[#BC9C6F] text-black rounded-lg px-8 py-8 text-xs md:h-[300px] lg:h-[300px]  mb-2 sm:mb-7">
           ...
           <p className="font-bold sm:text-sm md:text-xs lg:text-md  hidden sm:block text-center">"{item.testimonial}"</p>
